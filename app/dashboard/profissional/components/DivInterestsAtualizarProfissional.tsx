...
export default function DivInterestsAtualizarProfissional(props: DivInterestsAtualizarFormInterface){
    ...
    const placeholder = 'Selecione seus interesses de atuação:';
